(function(global) {
    ...
    API.$inject = [
        ...
        'APIChannelService',
        'APIGoodsService',
        'APIGoodsGalleryService',
        'APIGoodsSpecificationService',
        'APIFloorService',
        'APITopicService'
    ];
    ...
    function API(
        ...
        return {
            ...
            channel:APIChannelService,
            goods:APIGoodsService,
            goodsGallery:APIGoodsGalleryService,
            goodsSpecification:APIGoodsSpecificationService,
            floor:APIFloorService,
            topic:APITopicService
        };
    }
